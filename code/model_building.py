...
def model1():
	...
	checkpoint = ModelCheckpoint('bestModel1.h5', monitor='val_categorical_accuracy', verbose=0, save_best_only=True, save_weights_only=False, mode='max', period=1)
	...
	plot_model_history(history, "model1")
...
def model2():
	...
	early_stopping = EarlyStopping(monitor='val_categorical_accuracy', patience=10, verbose=1, mode='max', restore_best_weights=True)
	reduce_lr = ReduceLROnPlateau(monitor='val_categorical_accuracy', patience=3, verbose=1, factor=0.5, min_lr=0.00001)
	checkpoint = ModelCheckpoint('bestModel2.h5', monitor='val_categorical_accuracy', verbose=0, save_best_only=True, save_weights_only=False, mode='max', period=1)
	history = model.fit(x_train, y_train, batch_size=32, epochs=200, verbose=1, validation_data=(x_val, y_val), callbacks=[early_stopping, checkpoint, reduce_lr])
	...
	print("Validation: accuracy = ", accuracy_v, " loss = ", loss_v)
	print("Test: accuracy = ", accuracy, " loss = ", loss)
	plot_model_history(history, "model2")
...
def model3():
	...
	early_stopping = EarlyStopping(monitor='val_categorical_accuracy', patience=10, verbose=1, mode='max', restore_best_weights=True)
	reduce_lr = ReduceLROnPlateau(monitor='val_categorical_accuracy', patience=3, verbose=1, factor=0.5, min_lr=0.00001)
	checkpoint = ModelCheckpoint('bestModel3.h5', monitor='val_categorical_accuracy', verbose=0, save_best_only=True, save_weights_only=False, mode='max', period=1)
	history = model.fit(x_train, y_train, batch_size=32, epochs=200, verbose=1, validation_data=(x_val, y_val), callbacks=[early_stopping, checkpoint, reduce_lr])
	...
	print("Validation: accuracy = ", accuracy_v, " loss = ", loss_v)
	print("Test: accuracy = ", accuracy, " loss = ", loss)
	plot_model_history(history, "model3")
...
def model4():
	...
	print("Validation: accuracy = ", accuracy_v, " loss = ", loss_v)
	print("Test: accuracy = ", accuracy, " loss = ", loss)
	plot_model_history(history, "model4")
...
def model5():
	...
	early_stopping = EarlyStopping(monitor='val_categorical_accuracy', patience=10, verbose=1, mode='max', restore_best_weights=True)
	reduce_lr = ReduceLROnPlateau(monitor='val_categorical_accuracy', patience=3, verbose=1, factor=0.5, min_lr=0.00001)
	checkpoint = ModelCheckpoint('bestModel5.h5', monitor='val_categorical_accuracy', verbose=0, save_best_only=True, save_weights_only=False, mode='max', period=1)
	history = model.fit(x_train, y_train, batch_size=32, epochs=200, verbose=1, validation_data=(x_val, y_val), callbacks=[early_stopping, checkpoint, reduce_lr])
	...
	print("Validation: accuracy = ", accuracy_v, " loss = ", loss_v)
	print("Test: accuracy = ", accuracy, " loss = ", loss)
	plot_model_history(history, "model5")
